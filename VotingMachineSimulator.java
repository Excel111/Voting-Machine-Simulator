...
public class VotingMachineSimulator extends JFrame {
    ...
    public VotingMachineSimulator() {
        ...
        heading.setBackground(new Color(52, 73, 94)); // dark-blue grey
    ...
    private JPanel createVoteButton(final String name, Color color) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run(){
                new VotingMachineSimulator().setVisible(true);
            }
        });
    }
}
